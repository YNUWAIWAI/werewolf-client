  ...
  describe('selectedAgent exists', () => {
    ...
    describe('NIGHT', () => {
      test('HUNTER', () => {
        ...
        expect(wrapper.props().descriptionId).toBe('Modal.Description.hunterVote')
        expect(wrapper.props().id).toBe(2)
        expect(wrapper.props().image).toBe('https://werewolf.world/image/0.2/Moritz.jpg')
        expect(wrapper.props().name).toBe('モーリッツ')
        expect(wrapper.props().timer).toEqual({
      ...
      test('SEER', () => {
        ...
        expect(wrapper.props().descriptionId).toBe('Modal.Description.seerVote')
        expect(wrapper.props().id).toBe(2)
        expect(wrapper.props().image).toBe('https://werewolf.world/image/0.2/Moritz.jpg')
        expect(wrapper.props().name).toBe('モーリッツ')
        expect(wrapper.props().timer).toEqual({
      ...
      test('WEREWOLF', () => {
        ...
        expect(wrapper.props().descriptionId).toBe('Modal.Description.werewolfVote')
        expect(wrapper.props().id).toBe(2)
        expect(wrapper.props().image).toBe('https://werewolf.world/image/0.2/Moritz.jpg')
        expect(wrapper.props().name).toBe('モーリッツ')
        expect(wrapper.props().timer).toEqual({
      ...
      test('VILLAGER(default)', () => {
        ...
        expect(wrapper.props().descriptionId).toBe('Modal.Description.wait')
        expect(wrapper.props().id).toBe(2)
        expect(wrapper.props().image).toBe('https://werewolf.world/image/0.2/Moritz.jpg')
        expect(wrapper.props().name).toBe('モーリッツ')
        expect(wrapper.props().timer).toEqual({
