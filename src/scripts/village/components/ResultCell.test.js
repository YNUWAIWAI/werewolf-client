...
test('<ResultCell image="image" result="win" status="alive" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="win"
...
test('<ResultCell image="image" result="win" status="dead" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="win"
...
test('<ResultCell image="image" result="win" status="death by execution" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="win"
...
test('<ResultCell image="image" result="win" status="death by werewolf attack" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="win"
...
test('<ResultCell image="image" result="win" status="death by fear" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="win"
...
test('<ResultCell image="image" result="win" status="unnatural death" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="win"
...
test('<ResultCell image="image" result="lose" status="alive" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="lose"
...
test('<ResultCell image="image" result="lose" status="dead" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="lose"
...
test('<ResultCell image="image" result="lose" status="death by execution" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="lose"
...
test('<ResultCell image="image" result="lose" status="death by werewolf attack" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="lose"
...
test('<ResultCell image="image" result="lose" status="death by fear" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="lose"
...
test('<ResultCell image="image" result="lose" status="unnatural death" text="text" tooltip="tooltip" type="summary" />', () => {
  const wrapper = shallow(
    <ResultCell
      image="image"
      result="lose"
