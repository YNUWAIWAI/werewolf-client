...
test('<PredictionPlayer image="image" name="name" status="alive" />', () => {
  const wrapper = shallow(<PredictionPlayer image="image" name="name" status="alive" />)
...
test('<PredictionPlayer image="image" name="name" status="dead" />', () => {
  const wrapper = shallow(<PredictionPlayer image="image" name="name" status="dead" />)
...
test('<PredictionPlayer image="image" name="name" status="death by execution" />', () => {
  const wrapper = shallow(<PredictionPlayer image="image" name="name" status="death by execution" />)
...
test('<PredictionPlayer image="image" name="name" status="death by werewolf attack" />', () => {
  const wrapper = shallow(<PredictionPlayer image="image" name="name" status="death by werewolf attack" />)
...
test('<PredictionPlayer image="image" name="name" status="death by fear" />', () => {
  const wrapper = shallow(<PredictionPlayer image="image" name="name" status="death by fear" />)
...
test('<PredictionPlayer image="image" name="name" status="unnatural death" />', () => {
  const wrapper = shallow(<PredictionPlayer image="image" name="name" status="unnatural death" />)
