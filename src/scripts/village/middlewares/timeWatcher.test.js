...
test('SOCKET_MESSAGE phase: night -> day conversation, date: 0 -> 1', () => {
...
test('SOCKET_MESSAGE  phase: night -> day conversation, date: 0', () => {
  const dispatch = jest.fn()
  const getState = () => ({
    agents,
    base,
...
test('SOCKET_MESSAGE  phase: night, date: 0 -> 1', () => {
  const dispatch = jest.fn()
  const getState = () => ({
    agents,
    base,
...
test('SOCKET_MESSAGE phase: night, date: 0', () => {
  const dispatch = jest.fn()
  const getState = () => ({
    agents,
    base,
