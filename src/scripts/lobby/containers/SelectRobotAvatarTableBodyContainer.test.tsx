...
import {SelectRobotAvatarTableBody} from '../components/molecules/SelectAvatar/SelectRobotAvatarTableBody'
...
describe('<SelectRobotAvatarTableBodyContainer />', () => {
  ...
  test('handleAvatarImageClick', () => {
    ...
    wrapper.find(SelectRobotAvatarTableBody).props().handleAvatarImageClick(token)(image)
    expect(dispatch).toHaveBeenCalledTimes(1)
    expect(dispatch).toHaveBeenCalledWith({
      image,
      token,
